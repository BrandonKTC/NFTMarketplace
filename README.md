...
```
dfx canister call openD_backend listItem '(principal "sp3hj-caaaa-aaaaa-aaajq-cai", 2)'
```
...
```
dfx canister call sp3hj-caaaa-aaaaa-aaajq-cai transferOwnership '(principal "r7inp-6aaaa-aaaaa-aaabq-cai", true)'
```
